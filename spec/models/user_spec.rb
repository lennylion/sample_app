...
describe User do
  ...
  describe 'when password is not present' do  #can't get a fail RED, but only sometimes
    before do
  ...
  describe "when password doesn't match confirmation" do #can't get a fail RED
  ...
  describe "with a password that's too short" do
    before { @user.password = @user.password_confirmation = "a" * 5 } #FAILED!!!!!!!!!!! 
    it { should be_invalid }
  end

  describe "return value of authenticate method" do #can't get a fail RED
    before { @user.save }
